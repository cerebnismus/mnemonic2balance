...
cur.execute("INSERT INTO public.mnemonic2balance (mnemonics, addressbtc, addressbsc, balancebtc, balancebsc) VALUES (%s, %s, %s, %s, %s)", (mnemonic, AddressBTC, AddressBSC, BalanceBTC, BalanceBSC))
conn.commit()
